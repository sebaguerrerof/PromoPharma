...
- speaker: content = etiqueta superior opcional (texto plano, ej: "Speaker invitado"). imageUrl = foto del speaker o "" si no la tienes. style: speakerName, speakerRole, speakerBio, speakerOrg, speakerImageShape ("circle"|"square"|"rounded"), speakerCardBg, speakerVariant ("classic"|"spotlight")
